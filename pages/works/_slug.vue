	...
	<article class="pb-5 mb-5">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="/#works">{{ $t('Works') }}</a></li>
			</ol>
		</nav>
        ...
        <div class="row row-cols-1 row-cols-md-2">
            <div v-if="works.featured_image" class="col-md-4"><img class="contained-image" :src="require(`~/assets/images/works/${works.featured_image}`)" :alt="works.title" /></div>
                    ...
                    <div v-for="sample of works.images" :key="sample" class="work col bg-light">
                        <div class="ratio ratio-1x1">
                            <div class="d-flex justify-content-center align-items-center">
                                <img class="contained-image" v-if="sample" :src="require(`~/assets/images/works/${sample}`)" :alt="sample" />
                            </div>
                        </div>
                    </div>
                </div>
