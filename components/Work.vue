<template>
  <div class="work col bg-light">
      <div class="ratio ratio-1x1">
          <div class="d-flex justify-content-center align-items-center">
              <img class="contained-image" loading="lazy" v-if="image" :src="`https://sixdegz.mo.cloudinary.net/promoe/assets/images/works/${image}`" :alt="title" />
